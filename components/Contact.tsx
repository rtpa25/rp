      ...
      <div id='contact' className='mx-5 my-24 md:mx-40'>
        <div className='flex flex-col items-center'>
          ...
          <p className='max-w-screen-md text-lg text-center text-blue-900/95 md:px-12'>
            ...
            Sounds up to your streak
          </p>
          <a
            href={`mailto:pandaronit25@gmail.com`}
            className='mt-20 relative inline-flex items-center justify-center p-0.5 mbmr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800'>
